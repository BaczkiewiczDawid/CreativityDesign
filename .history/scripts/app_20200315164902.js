...
tlb.fromTo(".contentHeader", 1, {y: 80, opacity: 0}, {y: 0, opaicty: 1})
tlb.fromTo(".paragraphContent", 1, {y: 80, opacity: 0}, {y: 0, opaicty: 1}, .5)
tlb.fromTo(".contentImg", 1, {y: 80, opacity: 0}, {y: 0, opaicty: 1}, 0)