...
tla.fromTo(".remember", 1, {y: 100, opacity: 0}, {y: 0, opacity: 1});
tla.fromTo(".firstParagraph", 1, {y: 100, opacity: 0}, {y: 0, opacity: 1}, 0);
tla.fromTo(".secoundParagraph", 1, {y: 100, opacity: 0}, {y: 0, opacity: 1}, 0);
