...
tl.fromTo(".remember", 1, {y: 100, opacity: 0}, {y: 0, opacity: 1})
tl.fromTo(".firstParagraph", 1, {y: 100, opacity: 0}, {y: 0, opacity: 1})
tl.fromTo(".secoundParagraph", 1, {y: 100, opacity: 0}, {y: 0, opacity: 1})
